        ...
        <div class="card shadow-2 mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="#" class="btnn btn-primary btn-sm" onclick="openModal()">
                    <i class="fas fa-user-plus me-1"></i> Create Department
                </a>
                <div id="departmentModal" class="custom-modal-overlay" style="display:none;">
                    <div class="custom-modal">
                        ...
                        <form id="departmentForm">
                            <div class="custom-modal-body">
                                ...
                                <label for="departmentName" class="form-label">Department Name:<span id="depErr"></span></label>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-warning me-1 editDepartment"
                                            data-id="<?= $department['id'] ?>"
                                            data-name="<?= htmlspecialchars($department['department']) ?>">
                                            <i class="fas fa-edit"></i> Edit
                                        </button>

                                        <button class="btn btn-sm btn-danger deleteDepartment" data-id="<?= $department['id'] ?>">
